...
import 'package:mobile_test_project/ui/style/app_colors.dart';
import 'package:mobile_test_project/utils/constants.dart';
...
class Utils {
  ...
  static Widget getPriceText(
    ...
    return Column(
      ...
      children: [
        Text(
          '${hasDecimal ? Constants.priceFormat.format(price) : Constants.priceTotalFormat.format(price)} ${currency ?? 'AED'}',
